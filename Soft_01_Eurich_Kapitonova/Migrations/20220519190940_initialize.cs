...
namespace HW_01_Eurich_Kapitonova.Soft_01_Eurich_Kapitonova.Migrations
{
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BooksLeft = table.Column<int>(type: "int", nullable: true),
                    TotalNumberOfBooks = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AmountOfReadersItHelps = table.Column<int>(type: "int", nullable: true),
                    Token = table.Column<byte[]>(type: "rowversion", rowVersion: true, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RentedBooksAmount = table.Column<int>(type: "int", nullable: true),
